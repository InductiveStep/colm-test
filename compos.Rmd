...
This is an excuse to try out the {compos} package, by David Firth and Fiona Sammut.

The original analysis used data collated and published by [Democracy Club](https://candidates.democracyclub.org.uk/data/?election_id=parl.2024-07-04&field_group=results). This analysis uses [data](https://commonslibrary.parliament.uk/research-briefings/cbp-10009/) from the House of Commons Library, published 18 July.
...
```{r}
ge_dat <- read_csv("https://researchbriefings.files.parliament.uk/documents/CBP-10009/HoC-GE2024-results-by-candidate.csv")
```

Constituency-level data, used for the turnout figures:

```{r}
ge_turnout <- read_csv("https://researchbriefings.files.parliament.uk/documents/CBP-10009/HoC-GE2024-results-by-constituency.csv") |>
