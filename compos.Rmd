---
title: Did turnout predict the composition of Labour, Tory, and Reform votes in the
...
```{r}
mn_mod1 <- multinom(cbind(Con, Lab, Ref) ~ turnout_percentage, data = for_analy_counts)
mn_mod1 |> summary()
```
